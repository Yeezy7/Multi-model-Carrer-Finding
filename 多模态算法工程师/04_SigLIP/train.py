...
def train():
    ...
    config = SiglipConfig(vision_model_name_or_path="/home/flj/flj/Multi-model-Carrer-Finding/pre-trained-model/vit-base-patch16-224",
                          text_model_name_or_path="/home/flj/flj/Multi-model-Carrer-Finding/pre-trained-model/chinese-roberta-wwm-ext")
    ...
    args = TrainingArguments(
        output_dir="/home/flj/flj/Multi-model-Carrer-Finding/多模态算法工程师/04_SigLIP/outputs",
        do_train=True,
